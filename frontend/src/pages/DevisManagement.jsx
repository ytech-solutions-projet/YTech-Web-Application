                        ...
                        {quote.metadata?.features?.length > 0 && (
                          ...
                          <div className="workspace-quote-card__footer">
                            ...
                            <div className="workspace-inline-actions">
                              ...
                              {!isAdmin && quote.status === 'in_progress' && quote.metadata?.paymentTransactionId && (
                                <Link
                                  to={getReceiptPath(quote)}
              ...
              <div className="workspace-modal__footer">
                ...
                {!isAdmin && selectedQuote.status === 'approved' && (
                  <button
                    type="button"
                    className="workspace-inline-btn is-success"
                    onClick={() => openClientPaymentWindow(selectedQuote.id)}
                  >
                    Payer dans un autre onglet
                  </button>
                )}

                {!isAdmin && selectedQuote.status === 'in_progress' && selectedQuote.metadata?.paymentTransactionId && (
                  <Link
                    to={getReceiptPath(selectedQuote)}
                    className="workspace-inline-btn is-info"
                  >
                    Voir le recu
                  </Link>
