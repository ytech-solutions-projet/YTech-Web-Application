        ...
        <div className="container">
          <div className="marketing-form-shell auth-form-shell">
            <aside className="marketing-side-card auth-side-card">
              ...
              <h2 className="hero-panel__title">Utilisez votre compte enregistre dans la base.</h2>
              <p className="hero-panel__text">
              ...
              <ul className="stack-list">
                ...
                <li>Utilisez le mot de passe associe a votre compte base de donnees.</li>
              ...
              <form className="marketing-form auth-form" onSubmit={handleSubmit}>
                ...
                <div className="marketing-field">
                  ...
                  <div className="marketing-field__hint">
                    Votre compte doit exister cote base de donnees pour etre reconnu.
                  </div>
                  {errors.password ? (
